...
Status: local annotated tag created; remote push/publication pending.

## Candidate Tag

- Proposed tag: `v0.1.0-alpha.0`
- Tag type: annotated git tag after approval; local tag created
...
5. Create the tag only after approval. Completed locally for `v0.1.0-alpha.0`; remote push still requires target remote and repository visibility confirmation.
