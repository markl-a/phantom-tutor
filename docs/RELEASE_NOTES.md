...
- Installable package metadata, packaged seed content, and CI install/wheel/ruff/public-smoke gates.
...
- The default public release surface remains synthetic/offline and practice-side only; live job-board scraping, application submission, live LLM output, personalized data sync, and covert interview assistance are excluded.
